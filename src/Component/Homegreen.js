...
function Homegreen() {
  return (
    ...
    <div className="homeg">
      <div className="home__containerg">
        <div className="ecomart-banner">
          ...
          <p>Shop sustainably with our eco-friendly products</p>
        </div>
        <ImageSliderGreen/>
        </div>
        <br></br>
    ...
    <div className="ecomart-section-title">
      ...
      <p>Discover products that make a positive impact on the environment</p>
    </div>
    ...
    <img src="../images/ecomartbadgebanner.png" alt="" width="100%" />
